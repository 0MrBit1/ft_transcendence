        ...
        >
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            <motion.button
              ...
              className="group p-8 rounded-xl bg-card border-2 border-border hover:border-secondary transition-all duration-300 text-left cursor-pointer"
            ...
            <motion.button
              ...
              className="group p-8 rounded-xl bg-card border-2 border-border hover:border-accent transition-all duration-300 text-left cursor-pointer"
              style={{ boxShadow: "var(--shadow-card)" }}
            >
