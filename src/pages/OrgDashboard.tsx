...
import { CalendarDays, MapPin, Clock, Users, AlertCircle, UserPlus, MessageCircle, CheckCircle, XCircle } from "lucide-react";
import Navbar from "@/components/landing/Navbar";
import { motion } from "framer-motion";
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs";
import CreateEventDialog from "@/components/org/CreateEventDialog";
...
const OrgDashboard = () => {
  ...
  const fetchPendingRsvps = async (orgId: string) => {
    ...
    if (rsvps && rsvps.length > 0) {
      ...
      setPendingRsvps(rsvps.map((r: any) => ({
        ...r,
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8 pt-24 max-w-4xl">
        <div className="flex items-start justify-between mb-8">
          <div>
            <h1 className="text-2xl font-bold font-heading">{org?.name || "Organization"}</h1>
