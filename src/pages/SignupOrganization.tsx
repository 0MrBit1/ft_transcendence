      ...
      <div className="min-h-screen flex items-center justify-center pt-16 px-4">
        ...
        >
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold font-heading">Sign up as Organization</h1>
          ...
          <p className="text-center text-sm text-muted-foreground mt-6">
            Just a student?{" "}
            <a href="/signup/user" className="text-secondary font-medium hover:underline">Sign up as User</a>
            {" · "}
