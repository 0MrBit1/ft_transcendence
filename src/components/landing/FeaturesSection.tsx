...
const FeaturedEvents = () => {
  ...
  // Generate a muted color from event type for the placeholder thumbnail
            ...
            {events.map((event, i) => (
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <h3 className="text-sm font-medium text-foreground group-hover:text-accent transition-colors truncate mt-0.5">
                    {event.title}
                  </h3>
